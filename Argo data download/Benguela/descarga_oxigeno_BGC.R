...
######## 1) OXIGENO (DOXY) ################
# Subset by time.
from <- as.POSIXct("2002-01-01", tz="UTC")
...
ruta="C:/Users/Windows/Desktop/Argo Tesis/Benguela/BGC/"
...
setwd(ruta)
##################################################################################
df <- list.files(path="C:/Users/Windows/Desktop/Argo Tesis/Benguela/BGC") %>% 
  lapply(read_csv) %>% 
  bind_rows 
