...
# Subset by space.
rect <- list(longitude=c(5,25), latitude=c(-40,-10))
...
ruta="C:/Users/Windows/Desktop/Argo Tesis/Benguela/Core/"
...
setwd(ruta)
##################################################################################
df <- list.files(path="C:/Users/Windows/Desktop/Argo Tesis/Benguela/Core") %>% 
  lapply(read_csv) %>% 
  bind_rows 
